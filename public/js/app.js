...
},{"charenc":1,"crypt":2,"is-buffer":4}],4:[function(require,module,exports){
/**
...
},{"./xhr":9}],8:[function(require,module,exports){
/**
 * JSONP client.
 */
...
},{"../promise":23}],9:[function(require,module,exports){
/**
 * XMLHttp client.
 */
...
},{"../promise":23}],10:[function(require,module,exports){
/**
...
},{"./client/default":7,"./interceptor":15,"./interceptor/before":12,"./interceptor/cors":13,"./interceptor/header":14,"./interceptor/jsonp":16,"./interceptor/method":17,"./interceptor/mime":18,"./interceptor/timeout":19,"./promise":23}],11:[function(require,module,exports){
/**
 * Install plugin.
 */
...
},{"./http":10,"./lib/util":22,"./promise":23,"./resource":24,"./url":25}],12:[function(require,module,exports){
/**
 * Before Interceptor.
 */
...
},{"../client/jsonp":8}],14:[function(require,module,exports){
/**
 * Header Interceptor.
 */
...
},{"../promise":23}],16:[function(require,module,exports){
/**
 * JSONP Interceptor.
 */
...
},{"../client/jsonp":8}],17:[function(require,module,exports){
/**
...
},{"./lib/promise":20}],24:[function(require,module,exports){
/**
...
},{"./lib/url-template":21}],26:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/rajabishek/Code/begin/begin/node_modules/vue-strap/src/Alert.vue"
...
},{"vue":28,"vue-hot-reload-api":6,"vueify-insert-css":29}],28:[function(require,module,exports){
(function (process){
/*!
 * Vue.js v1.0.13
 * (c) 2015 Evan You
...
module.exports = {
    ...
    events: {
        clearUserDetails: function clearUserDetails() {
            this.clearUserDetails();
        },
        saveUserDetails: function saveUserDetails(user) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/app.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],31:[function(require,module,exports){
'use strict';
...
},{"./app.vue":30,"./components/register":38,"./filters/register":52,"./interceptors":54,"./routes":55,"vue":28,"vue-resource":11,"vue-router":26}],32:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/general/alertMessages.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],33:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/general/loadingButton.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],34:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/general/modal.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],35:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/general/spinner.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],36:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/partials/footer.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n/* Sticky footer styles\n-------------------------------------------------- */\n.footer {\n    background-color: #f5f5f5;\n    bottom: 0;\n    min-height: 60px;\n    position: absolute;\n    width: 100%;\n}\n\n.footer .footer-social-icons {\n    font-size: 27px;\n    padding-top: 10px;\n}\n\n.footer .footer-social-icons a {\n    color: #777;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":28,"vue-hot-reload-api":6,"vueify-insert-css":29}],37:[function(require,module,exports){
...
module.exports = {
    ...
    methods: {
        getGravatarImageLink: function getGravatarImageLink(email) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/partials/nav.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.navbar-login\n{\n    width: 305px;\n    padding: 10px;\n    padding-bottom: 0px;\n}\n\n.navbar-login-session\n{\n    padding: 10px;\n    padding-bottom: 0px;\n    padding-top: 0px;\n}\n\n.icon-size\n{\n    font-size: 87px;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"../../services/gravatar":57,"vue":28,"vue-hot-reload-api":6,"vueify-insert-css":29}],38:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	registerAllGlobalComponents: function registerAllGlobalComponents() {
...
},{"./general/alertMessages.vue":32,"./general/loadingButton.vue":33,"./general/modal.vue":34,"./general/spinner.vue":35,"./partials/footer.vue":36,"./partials/nav.vue":37,"vue":28,"vue-strap/src/Alert.vue":27}],39:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n.error {\n  margin: 0 auto;\n  text-align: center;\n}\n\n.error-code {\n  bottom: 60%;\n  color: #2d353c;\n  font-size: 96px;\n  line-height: 100px;\n}\n\n.m-b-10 {\n  margin-bottom: 10px!important;\n}\n\n.m-b-20 {\n  margin-bottom: 20px!important;\n}\n\n.m-t-20 {\n  margin-top: 20px!important;\n}\n\n.jumbotron-error-notfound {\n  text-align: center;\n  border-bottom: 1px solid #e5e5e5;\n}\n")
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<center>\n    <div class=\"jumbotron jumbotron-error-notfound\">\n        <div class=\"error-code m-b-10 m-t-20\">404 <i class=\"fa fa-warning\"></i></div>\n        <h4>We couldn't find the page..</h4>\n\n        <h5 class=\"lead\">\n            Sorry, but the page you are looking for was either not found or does not exist. <br>\n            Try refreshing the page or click the button below to go back to the Homepage.\n        </h5>\n        <div>\n            <a v-link=\"{ path: '/' }\" class=\"btn btn-md btn-info\">\n                <i class=\"fa fa-arrow-left\"></i>\n                Go back to Homepage                        \n            </a>\n        </div>\n    </div>\n</center>\n<footer-component></footer-component>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/404.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.error {\n  margin: 0 auto;\n  text-align: center;\n}\n\n.error-code {\n  bottom: 60%;\n  color: #2d353c;\n  font-size: 96px;\n  line-height: 100px;\n}\n\n.m-b-10 {\n  margin-bottom: 10px!important;\n}\n\n.m-b-20 {\n  margin-bottom: 20px!important;\n}\n\n.m-t-20 {\n  margin-top: 20px!important;\n}\n\n.jumbotron-error-notfound {\n  text-align: center;\n  border-bottom: 1px solid #e5e5e5;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":28,"vue-hot-reload-api":6,"vueify-insert-css":29}],40:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/auth.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],41:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        authenticate: function authenticate(e) {
            this.loading = true;
            var that = this;
            this.$http.post('/api/v1/login', this.user).then(function (response) {
                that.getUserData();
            }, function (response) {
                that.loading = false;
        ...
        displayErrorMessagesFromResponse: function displayErrorMessagesFromResponse(response) {
            var that = this;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/auth/login.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],42:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/auth/logout.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],43:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/auth/register.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],44:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/home.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],45:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/profile.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../../services/gravatar":57,"vue":28,"vue-hot-reload-api":6}],46:[function(require,module,exports){
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<nav-component></nav-component>\n<div class=\"container\">\n\t<div class=\"row\">\n\t\t<div class=\"col-sm-12\"><router-view></router-view></div>\n\t</div>\n</div>\n<footer-component></footer-component>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/tasks.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],47:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/tasks/create.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../../../services/errorHandler":56,"vue":28,"vue-hot-reload-api":6}],48:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    computed: {
        totalTasksCount: function totalTasksCount() {
            return this.pendingTasksCount + this.completedTasksCount;
        },

        tasksEmpty: function tasksEmpty() {
    ...
    events: {
        ...
        taskCompletionStatusWasToggled: function taskCompletionStatusWasToggled(task) {
            this.$broadcast('taskCompletionStatusWasToggled', task);
        },

        tasksCountChanged: function tasksCountChanged(task) {
            if (task.type === 'pending') this.pendingTasksCount = task.count;else if (task.type === 'completed') this.completedTasksCount = task.count;
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/tasks/index.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./list.vue":49,"vue":28,"vue-hot-reload-api":6}],49:[function(require,module,exports){
...
module.exports = {
    ...
    events: {
        ...
        modalWasApproved: function modalWasApproved() {
            this.deleteTask(this.currentTask);
            this.currentTask = null;
        },

        taskCompletionStatusWasToggled: function taskCompletionStatusWasToggled(task) {
            if (task.completed === true && this.type === 'completed') this.tasks.push(task);else if (task.completed === false && this.type === 'pending') this.tasks.push(task);
        }
    },
    ...
    methods: {
        ...
        setSelectedTask: function setSelectedTask(task) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/tasks/list.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.tasks-view.loading:before {\n    content: \"Loading...\";\n    position: absolute;\n    top: 16px;\n    left: 20px;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"../../../services/errorHandler":56,"vue":28,"vue-hot-reload-api":6,"vueify-insert-css":29}],50:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rajabishek/Code/begin/begin/resources/assets/js/components/views/tasks/show.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":28,"vue-hot-reload-api":6}],52:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	registerAllGlobally: function registerAllGlobally() {
		// register filters globally
		Vue.filter('strlimit', stringLimiter);
	}
};

},{"./stringLimiter":53,"vue":28}],53:[function(require,module,exports){
'use strict';
...
module.exports = function (Vue) {
    ...
    Vue.http.interceptors.push({
        ...
        response: function response(_response) {
            ...
            if (_response.data.data && _response.data.data.token && _response.data.data.token.length > 10) {
                localStorage.setItem('jwt-token', 'Bearer ' + _response.data.data.token);
            }
            return _response;
        }
...
},{"./components/views/404.vue":39,"./components/views/auth.vue":40,"./components/views/auth/login.vue":41,"./components/views/auth/logout.vue":42,"./components/views/auth/register.vue":43,"./components/views/home.vue":44,"./components/views/profile.vue":45,"./components/views/tasks.vue":46,"./components/views/tasks/create.vue":47,"./components/views/tasks/index.vue":48,"./components/views/tasks/show.vue":50,"./components/views/terms.vue":51}],56:[function(require,module,exports){
'use strict';

module.exports = {
    handleFailedResponse: function handleFailedResponse(response, component) {
        if (response.data.success === false && response.status) {
            status = response.status;
            if (status == 422 || status == 404) {
                this.displayErrorMessagesFromResponse(response, component);
            } else if (status == 400 || status == 401 || status == 403) component.$dispatch('clearUserDetails');else if (status == 500) component.messages = [{ type: 'danger', message: 'An unknown error occured, try sometime later.' }];
        }
    },

    displayErrorMessagesFromResponse: function displayErrorMessagesFromResponse(response, component) {
        component.messages = [];
        var errors = response.data.errors;
        for (var i = 0; i < errors.length; i++) {
...
module.exports = {
    ...
    getHashForEmail: function getHashForEmail(email) {
        return md5(email);
    },

    getImageLink: function getImageLink(email) {
        var size = arguments.length <= 1 || arguments[1] === undefined ? 150 : arguments[1];
